(function (f, g) {
    ...
    function xa() {
        ...
        g.get(AGARIO_SERVER_API + "info.php", function (a) {
            var b = {}, c;
            for (c in a.regions) {
                var d = c.split(":")[0];
                b[d] = b[d] || 0;
    ...
    function Sa(a) {
        ...
        switch (d.getUint8(c++)) {
            ...
            case 50:
                ...
                break;
            case 64:
                ba = d.getFloat64(c, !0), c += 8, ca = d.getFloat64(c, !0), c += 8, da = d.getFloat64(c, !0), c += 8, ea = d.getFloat64(c, !0), c += 8, N = (da + ba) / 2, O = (ea + ca) / 2, P = 1, 0 == l.length && (s = N, t = O, h = P)
        }
    }
    function Ua(a, b) {
        I = +new Date;
    ...
    function Ia() {
        ...
        if (null != w || 0 != z.length) if (null != w || ia) {
            ...
            if (null == w) for (a.font = "20px Ubuntu", b = 0; b < z.length; ++b) c = z[b].name || "An unnamed cell", ia || (c = "An unnamed cell"), -1 != E.indexOf(z[b].id) ? (l[0].name && (c = l[0].name), a.fillStyle = "#FFAAAA") : a.fillStyle = "#FFFFFF", c = b + 1 + ". " + c, a.fillText(c, 100 - a.measureText(c).width / 2, 70 + 24 * b);
            else for (b = c = 0; b < w.length; ++b) angEnd = c + w[b] * Math.PI * 2, a.fillStyle = Za[b + 1], a.beginPath(), a.moveTo(100, 140), a.arc(100, 140, 80, c, angEnd, !1), a.fill(), c = angEnd
        }
    }
    ...
    var F = f.location.protocol,
        Ga = "https:" == F;
    if (AGARIO_SERVER_HOST != f.location.hostname && "localhost" != f.location.hostname && "10.10.2.13" != f.location.hostname) f.location = F + AGARIO_SERVER_URL;
    else if (f.top != f) f.top.location = F + AGARIO_SERVER_URL;
    else {
